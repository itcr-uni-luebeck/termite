...
import de.itcr.termite.persistence.r4b.codesystem.CodeSystemOperationIndexPartitions
...
): ConceptIndexPartitions<ELEMENT, ID_TYPE, PREFIX_GENERATOR, KEY_GENERATOR>(indexName, elementPath, prefixGenerator, keyGenerator),
