...
fun interface Generator3<V1, V2, V3, R>: Function<R> {
    ...
    operator fun invoke(v1: V1, v2: V2, v3: V3): R

}

fun interface Generator4<V1, V2, V3, V4, R>: Function<R> {

    operator fun invoke(v1: V1, v2: V2, v3: V3, v4: V4): R

}

fun interface Generator5<V1, V2, V3, V4, V5, R>: Function<R> {

    operator fun invoke(v1: V1, v2: V2, v3: V3, v4: V4, v5: V5): R
